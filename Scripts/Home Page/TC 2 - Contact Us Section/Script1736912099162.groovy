...
WebUI.click(findTestObject('Home Page/Contact Us Section/Contact Us Button'))

WebUI.waitForElementVisible(findTestObject('Home Page/Contact Us Section/Form Email'), 5)
