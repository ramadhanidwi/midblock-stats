...
WebUI.waitForElementVisible(findTestObject('Home Page/Player Perfomance Section/Player Pefomance Text'), 3)

WebUI.verifyElementClickable(findTestObject('Home Page/Player Perfomance Section/See More Player Perfomance Button'))

WebUI.click(findTestObject('Home Page/Player Perfomance Section/See More Player Perfomance Button'))
